...
function display_tweet($usr_1, $style ='', $max_tweets = 1, $time = 60 ) {
	...
	if (!empty($tweets)) {
		...
		$twitter .= "<div class='tweet-modal'><a href='#' class='closetweet' onclick='closeTweet()'><i class='fa fa-times fa-lg'></i></a><section><div class='tweet-content'>No tweets.</div></section>";
	} //end if statement
