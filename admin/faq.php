...
<div class="container">
    <div class="grid">
        ...
        <div class="unit two-of-three">
            ...
            <p> You can add new rooms on the 'Edit Building' page by entering the details in the corresponding input areas and clicking the '+' button. Similarly you can remove a room by clicking the 'x' button next to it.</p>
